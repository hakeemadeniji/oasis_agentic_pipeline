...
class TestAuditDiagnosticProposal:
    ...
    def test_audit_returns_tuple(self, agent):
        ...
        result = agent.audit_diagnostic_proposal(
            predicted_class="Non Demented", confidence=85.0, mmse_score=28.0, atrophy_velocity=0.5
        )
...
class TestConfidenceThresholdRule:
    ...
    def test_very_low_confidence_rejected(self, agent):
        ...
        is_flagged, message = agent.audit_diagnostic_proposal(
            predicted_class="Non Demented", confidence=30.0, mmse_score=28.0, atrophy_velocity=0.5
        )
    ...
    def test_confidence_floor_in_message(self, agent):
        ...
        is_flagged, message = agent.audit_diagnostic_proposal(
            predicted_class="Non Demented", confidence=50.0, mmse_score=28.0, atrophy_velocity=0.5
        )
...
class TestCognitiveVsSpatialContradiction:
    ...
    def test_high_mmse_with_mild_dementia_rejected(self, agent):
        ...
        is_flagged, message = agent.audit_diagnostic_proposal(
            predicted_class="Mild Dementia", confidence=85.0, mmse_score=28.0, atrophy_velocity=0.5
        )
    ...
    def test_high_mmse_with_non_demented_approved(self, agent):
        ...
        is_flagged, message = agent.audit_diagnostic_proposal(
            predicted_class="Non Demented", confidence=85.0, mmse_score=29.0, atrophy_velocity=0.5
        )
...
class TestSilentStructuralDegradation:
    ...
    def test_atrophy_boundary_2_0(self, agent):
        ...
        is_flagged, message = agent.audit_diagnostic_proposal(
            predicted_class="Non Demented", confidence=85.0, mmse_score=28.5, atrophy_velocity=2.1
        )
    ...
    def test_atrophy_below_threshold_no_warning(self, agent):
        ...
        is_flagged, message = agent.audit_diagnostic_proposal(
            predicted_class="Non Demented", confidence=85.0, mmse_score=29.0, atrophy_velocity=1.5
        )
...
class TestCriticalFailureCheck:
    ...
    def test_mmse_boundary_12(self, agent):
        ...
        is_flagged, message = agent.audit_diagnostic_proposal(
            predicted_class="Non Demented", confidence=85.0, mmse_score=12.0, atrophy_velocity=0.5
        )
    ...
    def test_mmse_just_above_boundary(self, agent):
        ...
        is_flagged, message = agent.audit_diagnostic_proposal(
            predicted_class="Non Demented", confidence=85.0, mmse_score=12.1, atrophy_velocity=0.5
        )
...
class TestEdgeCases:
    ...
    def test_zero_confidence(self, agent):
        ...
        is_flagged, message = agent.audit_diagnostic_proposal(
            predicted_class="Non Demented", confidence=0.0, mmse_score=28.0, atrophy_velocity=0.5
        )
    ...
    def test_hundred_percent_confidence(self, agent):
        ...
        is_flagged, message = agent.audit_diagnostic_proposal(
            predicted_class="Non Demented", confidence=100.0, mmse_score=28.0, atrophy_velocity=0.5
        )
    ...
    def test_max_mmse(self, agent):
        ...
        is_flagged, message = agent.audit_diagnostic_proposal(
            predicted_class="Non Demented", confidence=85.0, mmse_score=30.0, atrophy_velocity=0.5
        )
...
class TestDiagnosticClasses:
    ...
    def test_mild_dementia_class(self, agent):
        ...
        is_flagged, message = agent.audit_diagnostic_proposal(
            predicted_class="Mild Dementia", confidence=85.0, mmse_score=22.0, atrophy_velocity=1.5
        )
...
class TestMessageContent:
    ...
    def test_warning_message_format(self, agent):
        ...
        is_flagged, message = agent.audit_diagnostic_proposal(
            predicted_class="Non Demented", confidence=85.0, mmse_score=29.0, atrophy_velocity=2.5
        )
...
class TestCustomConfidenceFloor:
    ...
    def test_lower_confidence_floor(self):
        ...
        is_flagged, message = agent.audit_diagnostic_proposal(
            predicted_class="Non Demented", confidence=55.0, mmse_score=28.0, atrophy_velocity=0.5
        )
    ...
    def test_higher_confidence_floor(self):
        ...
        is_flagged, message = agent.audit_diagnostic_proposal(
            predicted_class="Non Demented", confidence=75.0, mmse_score=28.0, atrophy_velocity=0.5
        )
