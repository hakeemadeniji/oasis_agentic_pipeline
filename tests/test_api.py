...
class TestAPIEndpoints:
    ...
    def test_batch_request_validation(self):
        ...
        valid_batch = {
            "requests": [
                {"patient_data": {"patient_id": f"P{i}", "age": 70, "mmse": 25}} for i in range(50)
            ]
        }
        ...
        invalid_batch = {
            "requests": [
                {"patient_data": {"patient_id": f"P{i}", "age": 70, "mmse": 25}} for i in range(150)
            ]
        }
...
class TestBatchProcessing:
    ...
    def test_batch_result_structure(self):
        ...
        assert (
            batch_result["summary"]["total_patients"]
            == batch_result["summary"]["successful"] + batch_result["summary"]["failed"]
        )
...
class TestRealtimeInference:
    ...
    def test_agent_result_structure(self):
        ...
        agent_result = {
            "type": "result",
            "agent": "vision",
            "data": {"class": "Very Mild Dementia", "confidence": 87.5},
        }

        assert agent_result["type"] == "result"
        assert agent_result["agent"] in [
            "vision",
            "biomarker",
            "rag",
            "explainer",
...
class TestErrorHandling:
    ...
    def test_error_response_structure(self):
        ...
        error_response = {"detail": "Patient not found"}
...
class TestIntegration:
    ...
    def test_complete_diagnosis_workflow(self, sample_patient_data=None, sample_image_base64=None):
        ...
        if sample_patient_data is None:
            sample_patient_data = {"patient_id": "OAS2_0001", "age": 75.5, "mmse": 24.0}
    ...
    def test_batch_to_export_workflow(self):
        ...
        batch_request = {
            "requests": [
                {"patient_data": {"patient_id": f"P{i}", "age": 70, "mmse": 25}} for i in range(5)
            ]
        }
        ...
        # Step 3: Mock results
        results = [{"patient_id": f"P{i}", "status": "success"} for i in range(5)]
