...
#
#================================================================
# download_oasis_freesurfer_tar.sh
#================================================================
#
# Usage: ./download_oasis_freesurfer_tar.sh <input_file.csv> <directory_name> <nitrc_ir_username>
#
# Download Freesurfer files from OASIS3 or OASIS4 on NITRC IR and organize the files - uses "tar" instead of "zip"
#
# Required inputs:
