...
#================================================================
#
# Usage: ./download_oasis_pup_files_by_partial_filename_match.sh <input_file.csv> <directory_name> <nitrc_ir_username> "string_to_match" <av1451_project_id_optional>
#
...
#       pup_id (e.g. OAS30001_AV45_PUPTIMECOURSE_d2430)
...
# Author: Sarah Keefe
# Source: https://github.com/NrgXnat/oasis-scripts (vendored verbatim for the OASIS Agentic Pipeline)
#
...
if [ ${#@} == 0 ]; then
    ...
    echo ""
    echo "Usage: $0 input_file.csv directory_name nitrc_username filename_string_to_match tau_project_id_optional"
    ...
    echo "<nitrc_username>: Your username used for accessing the requested XNAT site (you will be prompted for your password)"
    ...
    cat $INFILE | while IFS=, read -r PUP_ID; do
        ...
        echo "Checking files info url: ${FILES_INFO_URL}"
