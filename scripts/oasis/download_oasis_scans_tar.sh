...
#================================================================
#
# Usage: ./download_oasis_scans_tar.sh <input_file.csv> <directory_name> <nitrc_ir_username> <scan_type>
#
# Download scans of a specified type from OASIS3 or OASIS4 on NITRC IR and organize the files - uses "tar" instead of "zip"
#
# Required inputs:
