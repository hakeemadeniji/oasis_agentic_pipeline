...
class BatchProcessor:
    ...
    def __init__(self, workspace_root: str, max_workers: int = 4, use_gpu: bool = True):
    ...
    def process_single_patient(
        ...
        try:
            ...
            if image_path and os.path.exists(image_path):
                ...
                # argmax() returns a flat scalar index; unravel it to 2D (row, col)
                # coordinates. list(heatmap.argmax()) raised TypeError on the 0-d scalar.
            ...
            return {
                ...
                "ethics_audit": {"approved": not is_flagged, "message": restriction_log},
    ...
    def process_batch_sequential(
        self, patients: List[Dict[str, Any]], show_progress: bool = True
    ) -> List[Dict[str, Any]]:
    ...
    def process_csv_file(
        ...
        batch_summary = {
            ...
            "throughput_patients_per_hour": (len(results) / processing_time) * 3600
        ...
        if save_results:
            ...
            output_data = {"summary": batch_summary, "results": results}
        ...
        return {"summary": batch_summary, "results": results}
...
def main():
    ...
    processor = BatchProcessor(workspace_root=workspace_root, max_workers=args.workers)

    # Process batch
    batch_results = processor.process_csv_file(
        csv_path=args.csv, image_dir=args.image_dir, parallel=args.parallel, save_results=True
    )
