...
class ModelVersion:
    ...
    def __init__(self, version_id: str, model_name: str, model_path: str, metadata: Dict[str, Any]):
...
class ModelRegistry:
        ...
        if self.registry_file.exists():
            with open(self.registry_file, "r") as f:
                ...
                for model_name, versions in data.items():
                    self.versions[model_name] = [ModelVersion.from_dict(v) for v in versions]
    ...
    def register_model(
        ...
        version = ModelVersion(
            version_id=version_id, model_name=model_name, model_path=model_path, metadata=metadata
        )
...
class CheckpointManager:
    ...
    def __init__(self, checkpoint_dir: str, max_checkpoints: int = 5, save_best_only: bool = False):
    ...
    def save_checkpoint(
        ...
        self.checkpoints.append(
            {"path": str(checkpoint_path), "epoch": epoch, "metrics": metrics, "is_best": is_best}
        )
...
def main():
    ...
    if args.command == "register":
        ...
        comparison = registry.compare_versions(args.model_name, args.version_id1, args.version_id2)
