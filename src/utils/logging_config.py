...
def log_agent_execution(logger: logging.Logger, agent_name: str, patient_id: str, duration_ms: float, **kwargs):
    """Log agent execution"""
    logger.info(
...
def log_diagnosis(logger: logging.Logger, patient_id: str, diagnosis: str, confidence: float, approved: bool, **kwargs):
...
def log_performance_metric(logger: logging.Logger, metric_name: str, value: float, unit: str = "", **kwargs):
